          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            ...
            >
              ...
              <span class="text-sm text-green-700">
                Press <kbd class="px-1.5 py-0.5 bg-white border border-green-300 rounded text-xs font-mono">Enter</kbd> to create "<strong>{{ searchQuery.trim() }}</strong>"
              </span>
            </div>
            
            <!-- Game List -->
            <div v-if="availableGames.length === 0 && !searchQuery.trim()" class="text-sm text-gray-500 py-4 text-center">
              No other games available
            </div>

            <div v-else-if="availableGames.length === 0 && searchQuery.trim()" class="text-sm text-gray-500 py-4 text-center">
