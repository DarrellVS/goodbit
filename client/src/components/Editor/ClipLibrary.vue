...
<template>
  <div class="flex flex-col h-full bg-white/60 backdrop-blur-sm rounded-xl border border-gray-300 overflow-hidden dark:border-slate-700">
    ...
    <div class="flex-shrink-0 p-3 space-y-2 border-b border-gray-200 dark:border-slate-700">
      ...
      <div>
        <button
          class="w-full flex items-center justify-between px-2.5 py-2 text-sm rounded-lg bg-white/80 border transition-colors"
          :class="selectedTags.length ? 'border-orange-500/60 text-orange-700' : 'border-gray-300 text-gray-700 hover:border-orange-400'"
    ...
    <div v-else class="flex-1 overflow-y-auto p-3 space-y-5">
      ...
      >
        ...
        <button
          ...
          class="w-full group flex items-center gap-2 p-1.5 rounded-lg bg-orange-500/5 hover:bg-white transition-all border border-orange-400/40 hover:border-orange-500/60 cursor-pointer"
        ...
        >
          <div class="relative w-14 h-8 rounded overflow-hidden flex-shrink-0 bg-black">
            ...
            />
            <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-white/50">
