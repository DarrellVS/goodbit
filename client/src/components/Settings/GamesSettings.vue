...
<template>
  <section class="space-y-6">
    ...
    <div class="flex items-center gap-3">
      <div class="relative flex-1">
        ...
        <input
          ...
          class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
        />
      </div>
    ...
    <div
      ...
      class="p-6 text-center text-sm text-muted-500 bg-white rounded-lg border border-gray-200"
    >
      ...
      >
        <div class="min-w-0">
          <div class="flex items-center gap-2">
            ...
            <span
              v-if="game.hidden"
              class="px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wide bg-gray-200 text-gray-600"
            >
              Hidden
            </span>
          </div>
