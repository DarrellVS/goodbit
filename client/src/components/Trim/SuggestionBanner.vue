...
<template>
  <div
    v-if="loading"
    class="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-300 bg-white/60 text-sm text-gray-500"
  >
  ...
  >
    ...
    <div class="text-sm text-gray-800 min-w-0">
      ...
      <span class="text-gray-500"> — that is usually where the good bit is</span>
    </div>
