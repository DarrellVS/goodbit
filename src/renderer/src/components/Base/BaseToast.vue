...
const typeColors = {
  success: 'text-green-600 bg-green-500/8 border-green-200',
  error: 'text-red-600 bg-red-500/8 border-red-200',
  warning: 'text-orange-600 bg-orange-500/8 border-orange-200',
