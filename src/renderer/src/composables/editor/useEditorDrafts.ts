...
} from '@renderer/services/editorDraftsDb';
import {
  createProject,
  deleteProject,
  importEditorDrafts,
...
} from '@renderer/services/projects';
import {
  hasMigratedLocalDrafts,
  localIdsToDrop,
  markLocalDraftsMigrated,
  toImportEntries,
} from '@renderer/utils/draftMigration';
import { pickResumable } from '@renderer/utils/draftResume';
import type {
  DraftAudio,
  DraftClip,
  EditorDraft,
