...
import {
  ...
  deleteTagPattern,
  importTagPatterns,
} from '@renderer/services/tagPatterns';
import { getAllPatterns as getLocalPatterns } from '@renderer/services/tagPatternsDb';
import { TAG_PATTERNS, type TagPattern, type TagCategory } from '@renderer/utils/tagSuggestions';
